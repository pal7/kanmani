    ...
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <BrandMark className="text-5xl block mb-3" />
          <h1 className="font-display text-3xl text-ink">{t.appName}</h1>
        ...
        <form onSubmit={handleEmail} className="space-y-3">
          <input type="email" placeholder={t.emailPlaceholder} value={email} required
            ...
            className="w-full px-4 py-3 rounded-brand border border-accent-soft text-sm outline-none focus:border-accent transition-colors bg-white" />
